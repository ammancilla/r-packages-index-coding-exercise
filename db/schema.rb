...
ActiveRecord::Schema.define(version: 20180202173426) do
  ...
  create_table "authors_packages", force: :cascade do |t|
    ...
    t.index ["person_id"], name: "index_authors_packages_on_person_id"
  end
  ...
  create_table "maintainers_packages", force: :cascade do |t|
    ...
    t.index ["person_id"], name: "index_maintainers_packages_on_person_id"
  end
